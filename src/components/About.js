  ...
  return (
    <section className='about-wrapper'>
      ...
      <p className='about-text'>
        ...
        <br />
        I'm thrilled to bring my diverse background and Full Stack Web Development skills to your team. <button className='link-button' onClick={() => setCurrentSection('Contact')}>Let's connect</button> and discuss how I can contribute to your success.
      </p>
    </section>  
  );  
}
